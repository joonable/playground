...
def get_args():
    ...
    return args
'''
python3 audio_snr.py --clean_file ~/Downloads/cmu_us_jmk_arctic/wav/arctic_a0001.wav --noise_file ~/Downloads/NPARK/ch12.wav --output_clean_file ~/Desktop/clean.wav --output_noise_file ~/Desktop/noise.wav --output_noisy_file ~/Desktop/noisy.wav --snr 0
'''
